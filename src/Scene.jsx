...
function Scene() {
  return (
    <Canvas camera={{ position: [0, 1, 4] }} gl={{ antialias: true, alpha: false }} dpr={1}>
      <color args={['#cee7ff']} attach="background" />
      <Suspense fallback={null}>
        <CameraRig>
          <Float rotation={[-0.8, 0, -Math.PI / 2.5]} floatIntensity={4} rotationIntensity={6}>
            ...
            <Dna scale={0.095} position={[0, -1.6, 0.0]} />
          </Float>
